...
## Red Line
Uncapped penalty, regarless of fault or penalty that is cumulative with unlimited damages
...
## Rationale
Prevents disproportionate financial exposure for breach
...
## Metadata
- Playbook: nda
- Rule ID: contractual-penalty
- Status: approved
- Source Documents:
  - vault/nda/draft_ingest/ingest_20260425191039_bb43cd68/sources/Sample NDA Playbook.csv.xlsx (Sheet: Sample NDA Playbook, Clause # 7)
